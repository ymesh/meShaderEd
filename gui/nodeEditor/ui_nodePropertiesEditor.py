...
class Ui_NodePropertiesEditor(object):
    def setupUi(self, NodePropertiesEditor):
        ...
        self.verticalLayout = QtGui.QVBoxLayout(NodePropertiesEditor)
        self.verticalLayout.setSpacing(2)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.name_label = QtGui.QLabel(NodePropertiesEditor)
        self.name_label.setMinimumSize(QtCore.QSize(100, 0))
        self.name_label.setObjectName(_fromUtf8("name_label"))
        self.horizontalLayout_2.addWidget(self.name_label)
        self.name_lineEdit = QtGui.QLineEdit(NodePropertiesEditor)
        ...
        self.label_label = QtGui.QLabel(NodePropertiesEditor)
        ...
        self.label_lineEdit = QtGui.QLineEdit(NodePropertiesEditor)
        ...
        self.type_label = QtGui.QLabel(NodePropertiesEditor)
        ...
        self.type_comboBox = QtGui.QComboBox(NodePropertiesEditor)
        ...
        self.author_label = QtGui.QLabel(NodePropertiesEditor)
        ...
        self.author_lineEdit = QtGui.QLineEdit(NodePropertiesEditor)
        ...
        self.icon_label = QtGui.QLabel(NodePropertiesEditor)
        ...
        self.icon_lineEdit = QtGui.QLineEdit(NodePropertiesEditor)
        ...
        self.master_label = QtGui.QLabel(NodePropertiesEditor)
        ...
        self.master_lineEdit = QtGui.QLineEdit(NodePropertiesEditor)
        ...
        self.id_label = QtGui.QLabel(NodePropertiesEditor)
        ...
        self.id_lineEdit = QtGui.QLineEdit(NodePropertiesEditor)
        ...
        self.help_label = QtGui.QLabel(NodePropertiesEditor)
        ...
        self.help_plainTextEdit = QtGui.QPlainTextEdit(NodePropertiesEditor)

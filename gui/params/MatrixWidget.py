...
class Ui_MatrixWidget_array ( object ) :
	...
	def updateGui ( self, value ) :
		...
		for i in range ( self.widget.param.arraySize ) :
			elem = self.controls [ i ] 	
			if usePyQt4 :
				elem [ 1  ].setText ( QtCore.QString.number ( value [i][0][0], 'f', 3 ) )
				elem [ 2  ].setText ( QtCore.QString.number ( value [i][0][1], 'f', 3 ) )
				elem [ 3  ].setText ( QtCore.QString.number ( value [i][0][2], 'f', 3 ) )
				elem [ 4  ].setText ( QtCore.QString.number ( value [i][0][3], 'f', 3 ) )
				           
				elem [ 5  ].setText ( QtCore.QString.number ( value [i][1][0], 'f', 3 ) )
				elem [ 6  ].setText ( QtCore.QString.number ( value [i][1][1], 'f', 3 ) )
				elem [ 7  ].setText ( QtCore.QString.number ( value [i][1][2], 'f', 3 ) )
				elem [ 8  ].setText ( QtCore.QString.number ( value [i][1][3], 'f', 3 ) )
				           
				elem [ 9  ].setText ( QtCore.QString.number ( value [i][2][0], 'f', 3 ) )
				elem [ 10 ].setText ( QtCore.QString.number ( value [i][2][1], 'f', 3 ) )
				elem [ 11 ].setText ( QtCore.QString.number ( value [i][2][2], 'f', 3 ) )
				elem [ 12 ].setText ( QtCore.QString.number ( value [i][2][3], 'f', 3 ) )
				           
				elem [ 13 ].setText ( QtCore.QString.number ( value [i][3][0], 'f', 3 ) )
				elem [ 14 ].setText ( QtCore.QString.number ( value [i][3][1], 'f', 3 ) )
				elem [ 15 ].setText ( QtCore.QString.number ( value [i][3][2], 'f', 3 ) )
				elem [ 16 ].setText ( QtCore.QString.number ( value [i][3][3], 'f', 3 ) )
			else :

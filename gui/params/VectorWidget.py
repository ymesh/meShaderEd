...
#
# Ui_VectorWidget_array
#
class Ui_VectorWidget_array ( object ) :
    #
    # setupUi
    #
    def setupUi ( self, VectorWidget ) :
        ...
        for i in range ( self.widget.param.arraySize ) :
            self.labels.append ( QtModule.QLabel ( VectorWidget ) )
            ...
            elem.append ( QtModule.QLineEdit( VectorWidget ) )
            elem.append ( QtModule.QLineEdit( VectorWidget ) )
            elem.append ( QtModule.QLineEdit( VectorWidget ) )
            elem.append ( QtModule.QComboBox ( VectorWidget ) )
    ...
    def connectSignals ( self, VectorWidget ) :
        ...
        for i in range ( self.widget.param.arraySize ) :
            if usePyQt4 :
                VectorWidget.connect ( self.controls [ i ][0], QtCore.SIGNAL ( 'editingFinished()' ), self.onFloatEditEditingFinished )
                VectorWidget.connect ( self.controls [ i ][1], QtCore.SIGNAL ( 'editingFinished()' ), self.onFloatEditEditingFinished )
                VectorWidget.connect ( self.controls [ i ][2], QtCore.SIGNAL ( 'editingFinished()' ), self.onFloatEditEditingFinished )
                VectorWidget.connect ( self.controls [ i ][3], QtCore.SIGNAL ( 'activated(int)' ), self.onCurrentIndexChanged )
            else :
    ...
    def disconnectSignals ( self, VectorWidget ) :
        ...
        for i in range ( self.widget.param.arraySize ) :
            if usePyQt4 :
                VectorWidget.disconnect ( self.controls [ i ][0], QtCore.SIGNAL ( 'editingFinished()' ), self.onFloatEditEditingFinished )
                VectorWidget.disconnect ( self.controls [ i ][1], QtCore.SIGNAL ( 'editingFinished()' ), self.onFloatEditEditingFinished )
                VectorWidget.disconnect ( self.controls [ i ][2], QtCore.SIGNAL ( 'editingFinished()' ), self.onFloatEditEditingFinished )
                VectorWidget.disconnect ( self.controls [ i ][3], QtCore.SIGNAL( 'activated(int)' ), self.onCurrentIndexChanged )
            else :

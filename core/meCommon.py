...
def createDefaultProject ( settings, check_if_exist = False ) :
	#  
	project_filename = getSettingsStrValue ( settings, 'project_filename' )
	project = getSettingsStrValue ( settings, 'project' )
	project_shaders = getSettingsStrValue ( settings, 'project_shaders' )
	project_textures = getSettingsStrValue ( settings, 'project_textures' )
	shader_networks = getSettingsStrValue ( settings, 'shader_networks' )
	shader_sources = getSettingsStrValue ( settings,  'shader_sources' )
